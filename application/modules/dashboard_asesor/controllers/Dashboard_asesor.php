...
class Dashboard_asesor extends MY_Controller  {

//   var $parsing_form_input = array('id','nik','nama','alamat','no_telp','email');
//   var $tablename = 'm_dashboard_asesor';

    public function __construct() {
        parent::__construct();
        $this->load->model('m_dashboard_asesor','m_empp');
    ...
    public function index() {
        $data['caption_view'] = "Dashboard asesor";
		$data['title'] = "ASESOR PANEL :: ". $this->data['meta_title'];
        $data['content'] = 'dashboard_asesor/dashboard_asesor_view';
        ...
        $this->load->view('template_asesor', $data);
    }
