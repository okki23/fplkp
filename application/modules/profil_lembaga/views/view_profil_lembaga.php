...
is_verified
                    <tr>
                      <td colspan="3" style="width:100%;" > <a href="<?php echo base_url('profil_lembaga/print_lembaga/'.$profil_lbg->id); ?>" target="_blank" class="btn btn-primary" > <i class="fa fa-print" aria-hidden="true"></i> Cetak Profil </a> &nbsp; &nbsp; <a href="<?php echo base_url('profil_lembaga/ubah_profil/'.$profil_lbg->id); ?>" class="btn btn-primary" > <i class="fa fa-pencil-square-o" aria-hidden="true"></i>  Ubah Profil </a>  </td>
                    </tr>
