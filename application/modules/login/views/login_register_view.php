...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Isi Field Dibawah Untuk Mendaftar </p>

    <form accept-charset="UTF-8" role="form" action="<?php echo base_url('login/auth_reg'); ?>" method="POST">
      ...
      <div class="form-group has-feedback">
        <input type="text" name="nama_pemilik_lembaga"  class="form-control" placeholder="Nama Pemilik Lembaga">
      ...
      <div class="form-group has-feedback">
      <input type="text" name="notelp" class="form-control" placeholder="Nomor Telp">
