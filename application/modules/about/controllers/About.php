...
class about extends MY_Controller {
  ...
  var $parsing_form_input = array('id','name','note','path_upload','date_upload');
  var $tablename = 'm_about';
  var $pk = 'id';
 

    public function __construct() {
        parent::__construct();
        $this->load->model('m_about','m_prod');
    ...
    public function store(){
        ...
        if($id == '' || empty($id) || $id == NULL){
          $data['parseform'] = $this->m_prod->get_new($this->parsing_form_input);
        }else{
          $data['parseform'] = $this->m_prod->get_all($id,$this->tablename)->row();

        }
        $data['parse_view'] = 'about/about_store';
    ...
    public function save(){
      ...
      $datapos = $this->m_prod->input_array($this->parsing_form_input);
      $id = isset($datapos['id']) ? $datapos['id'] : '';
      $save = $this->m_prod->save($datapos,$id,$this->tablename);
      if($save){
    ...
    public function delete(){
      ...
      $del = $this->m_prod->delete($idpost,$this->tablename);
    ...
    public function get_bawahan_foreman($idforeman) {
        ...
        $data['namaabout'] = $this->session->userdata('namaabout');
        $data['idabout'] = $this->session->userdata('idabout');
        ...
        $data['listing'] = $this->m_prod->listing_bawahan_foreman($idforeman);

        //var_dump($data['listing']);
        $this->load->view('about/about_view_bawah', $data);
    }

    public function transaksi_id($param = '') {
        $data = $this->m_prod->get_no();
        $lastid = $data->row();
        $idnya = $lastid->id;
    ...
    public function add() {
        ...
        $data['idkasie'] = $this->session->userdata('idkasie');
        $data['idforeman'] = $this->session->userdata('idforeman');
        $data['getname'] = $this->m_prod->getname($data['username']);
        $data['nrp'] = $this->session->userdata('nrp');
        $data['lastid'] = $this->transaksi_id();
        $data['opt_kas_for'] = $this->m_prod->get_kas_for();
        $data['opt_about'] = $this->m_prod->opt_about();
        $this->load->view('about/about_add', $data);
    }
    ...
    public function edit() {
        ...
        $data['idforeman'] = $this->session->userdata('idforeman');
        $data['nrp'] = $this->session->userdata('nrp');
        //$data['listing'] = $this->m_prod->edit($id)->row();
    ...
    public function pro_add() {
        ...
        $sql = $this->m_prod->pro_add($datapos);
    ...
    public function detail() {
        ...
        $this->load->view('about/about_detail', $data);
    }
    ...
    public function pro_edit() {
        ...
        $sql = $this->m_prod->pro_edit($datapos);
    ...
    public function cetak() {
        ...
        $html = $this->load->view('about/about_print', $data, true);

        $this->pdf->writeHTML($html, true, false, true, false, "");
        ob_end_clean();
        //$this->pdf->Output("about Information.pdf", "I");
