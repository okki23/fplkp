...
class Dashboard_lembaga extends MY_Controller  {
...
//   var $tablename = 'm_dashboard';
    ...
    public function __construct() {
        parent::__construct();
        $this->load->model('m_dashboard_lembaga','m_empp');
    ...
    public function index() {
        ...
        $data['caption_view'] = "Dashboard lembaga";
		$data['title'] = "LEMBAGA PANEL :: ".$this->data['meta_title'];
        $data['content'] = 'dashboard_lembaga/dashboard_lembaga_view';
